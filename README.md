...
- [ ] 3.1 (Naman): Create “Teacher” model with profile (contact info, etc)
- [ ] 3.2 (Naman): Create “Engineer” model with profile (Alma Mater, About, Contact Info, etc)
...
- [ ] 3.9 (Naman): Deletion: Allow privileged users to delete groups, projects, classes, and comments.
